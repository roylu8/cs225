...
This report was generated for **roylu2** using **e953bfc288becb1ae42306c01a03170009acfed8** (latest commit as of **February 21st 2022, 11:59 pm**)
...
```
Original: "< 0 5 2 1 3 4 6 7 >" == s.str()
Expanded: "< 0 5 2 1 3 4 6 7 >"
==
"< 0 3 1 2 5 6 4 7 >"
```
...
==145== Command: ./test -r xml "List::split\ edge\ cases"
==145== 
==145== 
==145== HEAP SUMMARY:
==145==     in use at exit: 0 bytes in 0 blocks
==145==   total heap usage: 2,463 allocs, 2,463 frees, 285,696 bytes allocated
==145== 
